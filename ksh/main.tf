...
resource "coder_agent" "main" {
  ...
  startup_script         = <<-EOT
    ...
    /tmp/code-server/bin/code-server --install-extension editorconfig.editorconfig
    /tmp/code-server/bin/code-server --install-extension jannek-aalto.shell-function-outline
    /tmp/code-server/bin/code-server --install-extension mkhl.shfmt
    /tmp/code-server/bin/code-server --install-extension oderwat.indent-rainbow
    /tmp/code-server/bin/code-server --install-extension remisa.shellman
    /tmp/code-server/bin/code-server --install-extension shardulm94.trailing-spaces
    /tmp/code-server/bin/code-server --install-extension timonwong.shellcheck
